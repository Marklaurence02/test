        ...
        <div class="container"> 
            <div class="box form-box">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    // Modify the SQL query to include UserType
                    $result = mysqli_query($con, "SELECT * FROM Students WHERE Email='$email' AND Password='$password' AND UserType='$role'") or die("Select Error");
                    $row = mysqli_fetch_assoc($result);

                    if (empty($row)) {
                        // If not found in Students table, check the Teachers table
                        $result = mysqli_query($con, "SELECT * FROM Teachers WHERE Email='$email' AND Password='$password' AND UserType='$role'") or die("Select Error");
                        $row = mysqli_fetch_assoc($result);
                    }
