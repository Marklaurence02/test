                    ...
                    if(mysqli_num_rows($verify_query) != 0){
                        ...
                        if (isset($_POST['role'])){
                            ...
                            if($role == "student"){
                                ...
                                mysqli_query($con, "INSERT INTO students (Username, Email, Age, Password, School, Address) VALUES ('$username', '$email', '$age', '$password','$school','$address')") or die("Error Occurred");
